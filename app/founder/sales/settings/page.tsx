  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="flex items-center justify-between">
        ...
        <Link href="/founder/sales" className="rounded-lg border border-white/40 bg-white/20 px-3 py-1.5 text-sm font-medium text-white backdrop-blur hover:bg-white/30">
          ← Back to Sales
        </Link>
      </div>
