...
function Report({
  ...
  return (
    <div>
      ...
      {r.concerns.length > 0 && (
        <div className="mt-3 rounded-xl border border-brand-300/50 bg-gradient-to-br from-brand-500/40 to-brand-400/20 p-3 shadow-md ring-1 ring-inset ring-white/40 backdrop-blur-md">
