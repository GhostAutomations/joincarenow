...
function Report({
  ...
  return (
    <div>
      ...
      {r.concerns.length > 0 && (
        <div className="mt-3 rounded-xl border border-white/60 bg-gradient-to-br from-white/55 to-white/10 p-3 shadow-md ring-1 ring-inset ring-white/40 backdrop-blur-xl">
