...
export function TemplatesManager({ templates }: { templates: Template[] }) {
  ...
  return (
    <div className="space-y-8">
      {/* Editor */}
      <section className="rounded-2xl border border-white/40 bg-white/55 backdrop-blur-md shadow-sm p-6">
  ...
  return (
    <section>
      ...
      {items.length === 0 ? (
        ...
        <ul className="mt-3 divide-y divide-gray-100 rounded-2xl border border-white/40 bg-white/55 backdrop-blur-md shadow-sm">
          {items.map((t) => (
