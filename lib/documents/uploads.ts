...
export const UPLOAD_TYPES: UploadType[] = [
  ...
  { key: "driving_licence", label: "Driving licence", body: "Please upload a clear photo of BOTH the front and the back of your full UK driving licence.", twoSided: true },
