...
export async function sendProposalEmail(db: SupabaseClient, prospectId: string): Promise<{ ok?: boolean; error?: string }> {
  ...
  const body =
    ...
    `Want AI to do your first-round screening? Add Ruby, our AI recruitment assistant — from £79/month (£89 monthly, £790/year). Ruby reviews each applicant and gives your team an advisory hire recommendation; 40 applicants a month included, then 75p each.\n\n` +
